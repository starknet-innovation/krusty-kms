...
use std::fs;
use tongo_sdk::operations::{fund, ragequit, rollover, FundParams, RagequitParams, RolloverParams};
use tongo_sdk::TongoAccount;
...
fn test_fund_prover_vectors() {
    ...
    for vector in fund_vectors {
        ...
        let current_balance = ghoul_common::ElGamalCiphertext {
            l: g.clone(),
            r: g,
        };
