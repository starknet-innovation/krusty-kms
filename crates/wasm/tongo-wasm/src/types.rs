...
impl From<ghoul_common::AccountState> for WasmAccountState {
    fn from(state: ghoul_common::AccountState) -> Self {
        Self {
...
impl From<WasmAccountState> for ghoul_common::AccountState {
...
impl From<ghoul_common::SerializablePoint> for WasmPoint {
    fn from(p: ghoul_common::SerializablePoint) -> Self {
        Self { x: p.x, y: p.y }
    }
}

impl From<WasmPoint> for ghoul_common::SerializablePoint {
