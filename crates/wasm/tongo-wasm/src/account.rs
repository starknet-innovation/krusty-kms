...
pub struct WasmAccount {
    pub(crate) inner: tongo_sdk::TongoAccount,
}
...
impl WasmAccount {
    ...
    pub fn from_mnemonic(
        ...
        let inner = from_sdk_result(tongo_sdk::TongoAccount::from_mnemonic(
            mnemonic,
            address_index,
            account_index,
            contract_felt,
    ...
    pub fn from_private_key(
        ...
        let inner = from_sdk_result(tongo_sdk::TongoAccount::from_private_key(sk, contract_felt))
            .map_err(JsValue::from)?;
    ...
    pub fn from_keys(
        ...
        let inner =
            from_sdk_result(tongo_sdk::TongoAccount::from_keys(owner_sk, view_sk, contract_felt))
                .map_err(JsValue::from)?;
    ...
    pub fn decrypt_to_point(
        ...
        let cipher = ghoul_common::ElGamalCiphertext { l, r };
...
fn discrete_log_brute_force(
    ...
    let generator = she_core::StarkCurve::GENERATOR;
...
pub fn generate_mnemonic(word_count: Option<u8>) -> Result<String, JsValue> {
    ...
    from_sdk_result(kms::generate_mnemonic(count)).map_err(JsValue::from)
}

/// Validate a mnemonic phrase.
#[wasm_bindgen(js_name = "validateMnemonic")]
pub fn validate_mnemonic(mnemonic: &str) -> bool {
    kms::validate_mnemonic(mnemonic).is_ok()
}
...
pub fn derive_keypair(
    ...
    let kp = from_sdk_result(kms::derive_keypair(
        mnemonic,
        address_index,
        account_index,
        passphrase.as_deref(),
...
pub fn derive_view_keypair(
    ...
    let kp = from_sdk_result(kms::derive_view_keypair(
        mnemonic,
        address_index,
        account_index,
        passphrase.as_deref(),
...
pub fn derive_starknet_keypair(
    ...
    let kp = from_sdk_result(kms::derive_keypair_with_coin_type(
        mnemonic,
        address_index,
        account_index,
...
pub fn derive_oz_account_address(
    ...
    let address = from_sdk_result(kms::derive_oz_account_address(
        &public_key,
        &class_hash_felt,
        salt_felt.as_ref(),
    ))
...
pub fn derive_nostr_keypair(
    ...
    let kp = from_sdk_result(kms::derive_nostr_keypair(
        mnemonic,
        address_index,
        account_index,
        passphrase.as_deref(),
