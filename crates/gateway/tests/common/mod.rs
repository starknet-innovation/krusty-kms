...
use krusty_kms_domain::{AccountDescriptor, DerivationPath, FeltHex, KeyDomain, Provenance};
...
pub const TEST_PRIVATE_KEY: &str = "0x1234";
...
pub fn error_response(id: &serde_json::Value, code: i64, message: &str) -> String {
    serde_json::json!({
        "jsonrpc": "2.0",
        "id": id,
...
pub fn descriptor_for(signing_key: &SigningKey) -> AccountDescriptor {
